...
HD_PWD='C:/Users/liubo/Documents/GitHub projects/SPRO4/Firmware/uart_generation/uart_generation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log osc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source osc.tcl
