...
REM
REM Generated by Vivado on Thu May 28 15:59:42 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_wave_generator_vhdl.prj"
call xvhdl  --incr --relax -prj tb_wave_generator_vhdl.prj -log xvhdl.log
