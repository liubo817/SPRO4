...
REM
REM Generated by Vivado on Fri Apr 17 13:55:25 +0200 2026
...
echo "xvhdl --incr --relax -prj wave_generator_tb_vhdl.prj"
call xvhdl  --incr --relax -prj wave_generator_tb_vhdl.prj -log xvhdl.log
