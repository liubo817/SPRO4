...
HD_PWD='C:/Users/vikip/Desktop/GitHub Repos/SPRO4/Oscilloscope/Oscilloscope.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log osc_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source osc_top.tcl
