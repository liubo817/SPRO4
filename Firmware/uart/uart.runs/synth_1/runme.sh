...
HD_PWD='C:/Users/usnam/Documents/GitHub/SPRO4/uart/uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_main.tcl
