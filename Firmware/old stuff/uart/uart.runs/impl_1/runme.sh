...
HD_PWD='C:/Users/usnam/Documents/GitHub/SPRO4/uart/uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_main.tcl -notrace
