...
REM
REM Generated by Vivado on Sun May 03 01:32:12 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_decimator_vhdl.prj"
call xvhdl  --incr --relax -prj tb_decimator_vhdl.prj -log xvhdl.log
