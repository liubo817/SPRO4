...
#
# Script generated by Vivado on Fri Apr 17 13:40:02 +0200 2026
...
# script info
echo -e "xadc_wiz_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/usnam/Documents/GitHub/SPRO4/Firmware/project_1_backup/project_1_backup.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
...
Usage: xadc_wiz_0.sh [-rerun]\n\
Usage: xadc_wiz_0.sh [-reset_run]\n\
Usage: xadc_wiz_0.sh [-clean]\n\
